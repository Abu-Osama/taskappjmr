...
import 'package:jmrassignmentapp/main.dart';
    abstract class NetworkInfoI {
    Future<bool> isConnected();
    Future<ConnectivityResult>
    get connectivityResult;
...
class NetworkInfo implements NetworkInfoI {
  ...
  Stream<ConnectivityResult> get onConnectivityChanged => throw UnimplementedError(); // to check type of internet connectivity
 /* @override
